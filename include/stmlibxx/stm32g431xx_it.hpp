...
#ifndef _STM32G431XX_IT_HPP
#define _STM32G431XX_IT_HPP
...
public:
  ...
  static void TIM7_IRQHandler(void) { ISRVectorTable[TIM7_DAC_IRQn]->ISR(); }
  ...
  static void COMP4_IRQHandler(void) { ISRVectorTable[COMP4_IRQn]->ISR(); }
  ...
  static void FMAC_IRQHandle(void) { ISRVectorTable[FMAC_IRQn]->ISR(); }
