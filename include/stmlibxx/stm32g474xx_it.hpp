...
#ifndef _STM32G474XX_IT_HPP
#define _STM32G474XX_IT_HPP
...
public:
  ...
  static void RTC_TAMP_LSECSS_IRQHandler(void) {
    ISRVectorTable[RTC_TAMP_LSECSS_IRQn]->ISR();
  }
  ...
  static void FDCAN1_IT0_IRQHandler(void) {
    ISRVectorTable[FDCAN1_IT0_IRQn]->ISR();
  }
  static void FDCAN1_IT1_IRQHandler(void) {
    ISRVectorTable[FDCAN1_IT1_IRQn]->ISR();
  }
  static void EXTI9_5_IRQHandler(void) { ISRVectorTable[EXTI9_5_IRQn]->ISR(); }
  static void TIM1_BRK_TIM15_IRQHandler(void) {
    ISRVectorTable[TIM1_BRK_TIM15_IRQn]->ISR();
  }
  static void TIM1_UP_TIM16_IRQHandler(void) {
    ISRVectorTable[TIM1_UP_TIM16_IRQn]->ISR();
  }
  static void TIM1_TRG_COM_TIM17_IRQHandler(void) {
  ...
  static void TIM7_DAC_IRQHandler(void) {
    ISRVectorTable[TIM7_DAC_IRQn]->ISR();
  }
  ...
  static void DMA2_Channel3_IRQHandler(void) {
    ISRVectorTable[DMA2_Channel3_IRQn]->ISR();
  }
  static void DMA2_Channel4_IRQHandler(void) {
    ISRVectorTable[DMA2_Channel4_IRQn]->ISR();
  }
  static void DMA2_Channel5_IRQHandler(void) {
  ...
  static void COMP1_2_3_IRQHandler(void) {
    ISRVectorTable[COMP1_2_3_IRQn]->ISR();
  }
  static void COMP4_5_6_IRQHandler(void) {
    ISRVectorTable[COMP4_5_6_IRQn]->ISR();
  }
  static void COMP7_IRQHandler(void) { ISRVectorTable[COMP7_IRQn]->ISR(); }
  static void HRTIM1_Master_IRQHandler(void) {
    ISRVectorTable[HRTIM1_Master_IRQn]->ISR();
  }
  static void HRTIM1_TIMA_IRQHandler(void) {
    ISRVectorTable[HRTIM1_TIMA_IRQn]->ISR();
  }
  static void HRTIM1_TIMB_IRQHandler(void) {
    ISRVectorTable[HRTIM1_TIMB_IRQn]->ISR();
  }
  static void HRTIM1_TIMC_IRQHandler(void) {
    ISRVectorTable[HRTIM1_TIMC_IRQn]->ISR();
  }
  static void HRTIM1_TIMD_IRQHandler(void) {
    ISRVectorTable[HRTIM1_TIMD_IRQn]->ISR();
  }
  static void HRTIM1_TIME_IRQHandler(void) {
    ISRVectorTable[HRTIM1_TIME_IRQn]->ISR();
  }
  static void HRTIM1_FLT_IRQHandler(void) {
    ISRVectorTable[HRTIM1_FLT_IRQn]->ISR();
  }
  static void HRTIM1_TIMF_IRQHandler(void) {
    ISRVectorTable[HRTIM1_TIMF_IRQn]->ISR();
  }
  static void CRS_IRQHandler(void) { ISRVectorTable[CRS_IRQn]->ISR(); }
  static void SAI1_IRQHandler(void) { ISRVectorTable[SAI1_IRQn]->ISR(); }
  static void TIM20_BRK_IRQHandler(void) {
    ISRVectorTable[TIM20_BRK_IRQn]->ISR();
  }
  static void TIM20_UP_IRQHandler(void) {
    ISRVectorTable[TIM20_UP_IRQn]->ISR();
  }
  static void TIM20_TRG_COM_IRQHandler(void) {
    ISRVectorTable[TIM20_TRG_COM_IRQn]->ISR();
  }
  static void TIM20_CC_IRQHandler(void) {
    ISRVectorTable[TIM20_CC_IRQn]->ISR();
  }
  ...
  static void FDCAN2_IT0_IRQHandler(void) {
    ISRVectorTable[FDCAN2_IT0_IRQn]->ISR();
  }
  static void FDCAN2_IT1_IRQHandler(void) {
    ISRVectorTable[FDCAN2_IT1_IRQn]->ISR();
  }
  static void FDCAN3_IT0_IRQHandler(void) {
    ISRVectorTable[FDCAN3_IT0_IRQn]->ISR();
  }
  static void FDCAN3_IT1_IRQHandler(void) {
    ISRVectorTable[FDCAN3_IT1_IRQn]->ISR();
  }
  ...
  static void DMAMUX_OVR_IRQHandler(void) {
    ISRVectorTable[DMAMUX_OVR_IRQn]->ISR();
  }
  static void QUADSPI_IRQHandler(void) { ISRVectorTable[QUADSPI_IRQn]->ISR(); }
  static void DMA1_Channel8_IRQHandler(void) {
    ISRVectorTable[DMA1_Channel8_IRQn]->ISR();
  }
  static void DMA2_Channel6_IRQHandler(void) {
    ISRVectorTable[DMA2_Channel6_IRQn]->ISR();
  }
  static void DMA2_Channel7_IRQHandler(void) {
    ISRVectorTable[DMA2_Channel7_IRQn]->ISR();
  }
  static void DMA2_Channel8_IRQHandler(void) {
    ISRVectorTable[DMA2_Channel8_IRQn]->ISR();
  }
