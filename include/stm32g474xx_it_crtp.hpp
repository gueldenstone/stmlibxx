...
class Interrupt {
 public:
  ...
  Interrupt(){};
  // Register function
  void Register(IRQn_Type interrupt_number, Interrupt<T>* intThisPtr) {
  ...
  static void HRTIM1_Master_IRQHandler(void) { ISRVectorTable[HRTIM1_Master_IRQn]->ISR(); }
  static void HRTIM1_TIMA_IRQHandler(void) { ISRVectorTable[HRTIM1_TIMA_IRQn]->ISR(); }
  static void HRTIM1_TIMB_IRQHandler(void) { ISRVectorTable[HRTIM1_TIMB_IRQn]->ISR(); }
  static void HRTIM1_TIMC_IRQHandler(void) { ISRVectorTable[HRTIM1_TIMC_IRQn]->ISR(); }
  static void HRTIM1_TIMD_IRQHandler(void) { ISRVectorTable[HRTIM1_TIMD_IRQn]->ISR(); }
  static void HRTIM1_TIME_IRQHandler(void) { ISRVectorTable[HRTIM1_TIME_IRQn]->ISR(); }
  static void HRTIM1_FLT_IRQHandler(void) { ISRVectorTable[HRTIM1_FLT_IRQn]->ISR(); }
  static void HRTIM1_TIMF_IRQHandler(void) { ISRVectorTable[HRTIM1_TIMF_IRQn]->ISR(); }
