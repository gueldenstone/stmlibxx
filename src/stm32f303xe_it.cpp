...
void Interrupt::I2C3_EV_IRQHandler(void) {
  ISRVectorTable[I2C3_EV_IRQn]->ISR();
}
void Interrupt::I2C3_ER_IRQHandler(void) {
  ISRVectorTable[I2C3_ER_IRQn]->ISR();
}
...
void Interrupt::TIM20_BRK_IRQHandler(void) {
  ISRVectorTable[TIM20_BRK_IRQn]->ISR();
}
void Interrupt::TIM20_UP_IRQHandler(void) {
  ISRVectorTable[TIM20_UP_IRQn]->ISR();
}
void Interrupt::TIM20_TRG_COM_IRQHandler(void) {
  ISRVectorTable[TIM20_TRG_COM_IRQn]->ISR();
}
void Interrupt::TIM20_CC_IRQHandler(void) {
